...
📓 Usage examples (loading model outputs, computing heights, generating figures, obtain values at a grid-point closest to input location, etc) are available here: [usage_examples.ipynb](usage_examples.ipynb)
...
#### Grid dimensions and spatial extent
